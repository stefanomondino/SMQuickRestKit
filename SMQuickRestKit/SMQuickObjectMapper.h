...
/**
 Singleton instance of SMQuickObjectManager
 @return: A singleton instance of SMQuickObjectManager
 */
+ (SMQuickObjectMapper *) sharedObjectMapper;

/**
 Returns a list of all RKObjectManagers configured in SMQuickObjectManager
...
/**
 Initialize a new RKObjectManager and adds it to the SMQuickObjectMapper.
...
/**
 ...
 @example: [SMQuickObjectMapper registerClass:[RKXMLSerialization class] forMIMEType:@"text/xml"]
